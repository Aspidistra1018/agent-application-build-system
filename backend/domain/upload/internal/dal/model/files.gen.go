...
type Files struct {
	...
	Status        int32          `gorm:"column:status;not null;comment:statusï¼?invalidï¼?valid" json:"status"`                                   // statusï¼?invalidï¼?valid
	Comment       string         `gorm:"column:comment;not null;comment:file comment" json:"comment"`                                           // file comment
	Source        int32          `gorm:"column:source;not null;comment:sourceï¼? from API," json:"source"`                                       // sourceï¼? from API,
