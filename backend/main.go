...
func startHttpServer() {
	...
	// CORS配置 - 同时支持localhost�?27.0.0.1
	config := cors.DefaultConfig()
	config.AllowOrigins = []string{
		"http://localhost:5173", // 统一登录系统前端
		"http://127.0.0.1:5173", // 统一登录系统前端（IP形式�?		"http://localhost:8080", // Agent系统前端
		"http://127.0.0.1:8080", // Agent系统前端（IP形式�?		"http://localhost:3000", // Web系统前端
